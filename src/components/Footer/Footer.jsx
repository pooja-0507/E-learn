        ...
        <div className="container">
          <div className="grid md:grid-cols-4 md:gap-4 py-5 border-t-2 border-gray-300/10 text-black">
            ...
            <div className="py-8 px-4 space-y-4">
              ...
              <p>
              E-Tutor offers personalized, interactive tutoring to help students achieve academic success. With expert guidance and flexible learning options, our platform empowers students to grow and excel in their studies.
              </p>
